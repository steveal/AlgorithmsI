...
public class Point implements Comparable<Point> {
     ...
     *         integer if this point is less than the argument point; and a positive integer if this point is greater
    ...
    public Comparator<Point> slopeOrder() {
        /* YOUR CODE HERE */
        return new PointSlopeOrder(this);
    }
    ...
    private class PointSlopeOrder implements Comparator<Point> {
        ...
        public PointSlopeOrder(Point point) {
            this.p = point;
        }
        ...
        public int compare(Point q1, Point q2) {
            // TODO
            double pq1slope = p.slopeTo(q1);
            double pq2slope = p.slopeTo(q2);
            // int pq1x = p.x - q1.x;
            // int pq1y = p.x - q1.y;
            // int pq2x = p.x - q2.x;
            // int pq2y = p.x - q2.y;
            // if(pq1x !=0 && pq1y !=0 && pq2x !=0 && pq2y !=0) {
            // return pq1x*pq2y - pq2x*pq1y;
            // }else if(pq1slope < pq2slope ) {
            // return -1;
            // }else if(pq1slope > pq2slope) {
            // return 1;
            // }else {
